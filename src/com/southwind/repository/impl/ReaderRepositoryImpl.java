...
public class ReaderRepositoryImpl implements ReaderRepository {
    ...
    public Reader login(String username, String passowrd) {
        ...
        try {
            ...
            if(resultSet.next()){
                reader = new Reader(resultSet.getInt(1),resultSet.getString(2),resultSet.getString(3),resultSet.getString(4),resultSet.getInt(5),resultSet.getInt(6),resultSet.getString(7));
            }
